...
const generateStyleCombinations = (component: ThemeComponent, variables: VariableToken): Record<string, StyleProperties> => {
...
export const getThemeComponents = <C extends string>(
    ...
    for (const [name, component] of Object.entries<ThemeComponent>(components)) {
